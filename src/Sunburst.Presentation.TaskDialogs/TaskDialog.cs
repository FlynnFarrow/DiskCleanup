...
namespace Sunburst.Presentation.TaskDialogs
{
    public class TaskDialog
    {
        ...
        */
        ...
        public void Show(Window dialogOwner, out int buttonResult, out int radioButtonResult, out bool verificationFlagResult)
        {
            ...
            config.hwndParent = (dialogOwner != null) ? (new WindowInteropHelper(dialogOwner)).Handle : IntPtr.Zero;
    ...
    public struct TaskDialogDriver
    {
        ...
        internal TaskDialogDriver(IntPtr hwnd)
        {
            this.hwnd = hwnd;
        }
